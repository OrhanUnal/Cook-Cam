...
class MainActivity : AppCompatActivity() {
    ...
    private fun showThemePopup(anchorView: View, sharedPreferences: SharedPreferences) {
        ...
        popupView.findViewById<View?>(R.id.creditsButton)?.setOnClickListener {
            popupWindow.dismiss()
    ...
    private fun startMain(sharedPreferences: SharedPreferences, savedInstanceState: Bundle?) {
        ...
        when (resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK) {
            Configuration.UI_MODE_NIGHT_YES -> btnMenu.setImageResource(R.drawable.dark_mode_menu_buton_2)
            Configuration.UI_MODE_NIGHT_NO -> btnMenu.setImageResource(R.drawable.popup_icon_48x48)
        }
        ...
        if (savedInstanceState == null) replaceFragment(aiChatFragment)
    ...
    private fun checkPolicy(sharedPreferences: SharedPreferences, saved: Bundle?) {
        ...
        confirmButton.setOnClickListener {
            if (checkBox.isChecked) {
                ...
                Toast.makeText(
                    this,
                    "Please read and confirm our policy and check the box.",
                    Toast.LENGTH_SHORT
                ).show()
